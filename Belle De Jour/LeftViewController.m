...
- (void)viewDidLoad
{
    ...
    {
    self.tableView = ({
        titles = @[@"Home", @"Services",@"Offers",@"Staff", @"Profile",@"Feeback",@"Contact Us", @"Log In",@"About"];
        images = @[@"IconHome", @"IconCalendar",@"icon_forum", @"IconProfile", @"IconSettings",@"icon_post" ,@"icon_call",@"icon_key",@"icon_information"];
    ...
    {
        self.tableView = ({
            titles = @[[[SharedManager sharedManager]userProfile].name, @"Home", @"Services",@"Offers",@"Staff", @"Profile",@"Feedback",@"Contact Us", @"Log In",@"About"];
            images = @[@"IconEmpty",@"IconHome", @"IconCalendar",@"icon_forum", @"IconProfile", @"IconSettings",@"icon_post", @"icon_call",@"icon_key",@"icon_information"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 4:
        {
            ...
            break;
        case 5:
        [self.sideMenuViewController setContentViewController:[[UINavigationController alloc] initWithRootViewController:[self.storyboard instantiateViewControllerWithIdentifier:@"FeedbackViewController"]]
                                                     animated:YES];
        [self.sideMenuViewController hideMenuViewController];
        break;
        case 6:
